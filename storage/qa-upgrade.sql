...
CREATE TABLE IF NOT EXISTS qa_questions (
  ...
  status ENUM('pending','answered') NOT NULL DEFAULT 'pending' COMMENT '状态：待回答/已回答',
...
-- ALTER TABLE qa_questions ADD COLUMN status ENUM('pending','answered') NOT NULL DEFAULT 'pending';
